...
def construct_neighbour_of_zero_list(state):
    ...
    if position_of_zero[0] > 0:
        list_of_neighbours.append((position_of_zero[0] - 1, position_of_zero[1]))
    if position_of_zero[0] < 2:
        list_of_neighbours.append((position_of_zero[0] + 1, position_of_zero[1]))
    if position_of_zero[1] > 0:
        list_of_neighbours.append((position_of_zero[0], position_of_zero[1] - 1))
...
ic("First:" + str(iddfs(init_state([8, 6, 7, 2, 5, 4, 0, 3, 1]), 30)))
ic("Second" + str(iddfs(init_state([2, 5, 3, 1, 0, 6, 4, 7, 8]), 30)))
ic("Third" + str(iddfs(init_state([2, 7, 5, 0, 8, 4, 3, 1, 6]), 30)))
